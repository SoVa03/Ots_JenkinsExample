...
Процедура ИсполняемыеСценарии() Экспорт
    ...
    ЮТТесты.ДобавитьТестовыйНабор("Документ Расход товара: Проверка проведения").ВТранзакции()
		...
		.ДобавитьТест("ПроверкаПроведенияПозитив2",,"Позитив")
		.ДобавитьТест("ПроверкаПроведенияНегатив2",,"Негатив")
		;
...
Процедура ПроверкаПроведенияПозитив2() Экспорт
...
Процедура ПроверкаПроведенияНегатив2() Экспорт
